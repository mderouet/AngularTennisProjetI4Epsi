# Angular 2 Ugo Edition
[![Build Status][travis-badge]][travis-badge-url]

This repository holds the TypeScript source code of start are the [angular.io quickstart](https://angular.io/docs/ts/latest/quickstart.html),
