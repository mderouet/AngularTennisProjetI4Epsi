...
var Rencontres = (function () {
    function Rencontres(id, date_debut, date_fin, cours_tennis_libelle, cours_tennis_image, id_tournoi, tournoi, equipe_id, equipe_libelle, nom, prenom, uri_image) {
        this.id = id;
